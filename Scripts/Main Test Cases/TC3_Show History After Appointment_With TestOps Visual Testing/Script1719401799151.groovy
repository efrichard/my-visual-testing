...
WebUI.takeElementScreenshotAsCheckpoint('Form Appointment', AppointmentDialogObject)
...
WebUI.setText(findTestObject('Page_CuraAppointment/txt_VisitDate'), '30/06/2024')
...
WebUI.verifyMatch('30/06/2024', WebUI.getText(findTestObject('Page_AppointmentConfirmation/lbl_VisitDate')), false)
...
WebUI.click(findTestObject('Vision_Common/menu_toggle'))
